...
public class enterdetails extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException 
    {
       ...
       String PW="root";
        ...
        String brcdesig=request.getParameter("BRC");
        ...
        String beodesig=request.getParameter("BEO");
       ...
       PreparedStatement teachercount=null;
       PreparedStatement teacher_details=null;
       PreparedStatement org=null;
       Connection con=null;
       try
       {
           ...
           student.execute();
           student.close();
         scst=con.prepareStatement("insert into SC_ST_children(school_id,b_sc,b_st,g_sc,g_st,total) values(?,?,?,?,?,?)");
         scst.setInt(1, schoolid);
         scst.setString(2, bsc);
         scst.setString(3, bst);
         scst.setString(4, gsc);
         scst.setString(5, gst);
         scst.setString(6, total);
         scst.execute();
         scst.close();
         teachercount=con.prepareStatement("insert into teacher_count(school_id, male,female,full_part,total) values(?,?,?,?,?)");
         teachercount.setInt(1, schoolid);
         teachercount.setString(2, tcm);
         teachercount.setString(3, tcf);
         teachercount.setString(4, tcty);
         ...
         teacher_details.setString(4,hmnumber);
         teacher_details.setString(5,hmemail);
         teacher_details.execute();
         teacher_details.close();
         teacher_details=con.prepareStatement("insert into teacher_details(school_id,designation,tname,contact_number,email) values (?,?,?,?,?)");
         teacher_details.setInt(1, schoolid);
         teacher_details.setString(2,atdesig);
         teacher_details.setString(3,atname);
         ...
         teacher_details.setString(3,crpname);
         teacher_details.setString(4,crpnumber);
         teacher_details.setString(5,crpemail);
         teacher_details.execute();
         teacher_details.close();
         teacher_details=con.prepareStatement("insert into teacher_details(school_id,designation,tname,contact_number,email) values (?,?,?,?,?)");
         teacher_details.setInt(1, schoolid);
         teacher_details.setString(2,brcdesig);
         teacher_details.setString(3,brcname);
         teacher_details.setString(4,brcnumber);
         teacher_details.setString(5,brcemail);
         teacher_details.execute();
         teacher_details.close();
          teacher_details=con.prepareStatement("insert into teacher_details(school_id,designation,tname,contact_number,email) values (?,?,?,?,?)");
         teacher_details.setInt(1, schoolid);
         teacher_details.setString(2,beodesig);
         teacher_details.setString(3,beoname);
         ...
         org.setString(3, sp413);
         org.setString(4, sp414);
         org.execute();
         org.close();
         org=con.prepareStatement("insert into individual_donor(donor_name,total_members,major_activities,contact_details) values(?,?,?,?)");
         org.setString(1, sp421);
         org.setString(2, sp422);
         org.setString(3, sp423);
         org.setString(4, sp424);
         org.execute();
         org.close();
         org=con.prepareStatement("insert into individual_donor(donor_name,total_members,major_activities,contact_details) values(?,?,?,?)");
         org.setString(1, sp431);
         org.setString(2, sp432);
