       ...
       try
       {
          ...
          classroom_environment.setInt(1,schoolid);
           ...
           classroom_environment.execute();
                      classroom_environment.setInt(1,schoolid);
                          for(int i=0;i<=4;i++){
               classroom_environment.setString(i+2,vv[i]);
           }
           classroom_environment.execute();
                      classroom_environment.setInt(1,schoolid);
                          for(int i=0;i<=4;i++){
