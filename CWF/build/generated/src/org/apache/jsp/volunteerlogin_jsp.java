...
public final class volunteerlogin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<div id=\"fh5co-logo\"><a href=\"index.jspp\">CWF<span>.</span></a></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t<h3>Volunteer Login</h3>\r\n");
      out.write("\t\t\t\t\t<form action=\"loginvolunteer\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<div class=\"row form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"email\">Email</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" id=\"email\" required name=\"loginusername\" class=\"form-control\" placeholder=\"Your email address\" required>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("                                            <div class=\"row form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"email\">Password</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"password\" id=\"password\" required name=\"loginpassword\" class=\"form-control\" placeholder=\"Your Password\" required>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\r\n");
