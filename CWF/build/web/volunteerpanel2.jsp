	...
	<header id="fh5co-header" class="fh5co-cover fh5co-cover-sm" role="banner" style="background-image:url(images/img_bg_1.jpg);" data-stellar-background-ratio="0.5">
					...
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeInUp">
							<h1 class="mb30">CareWorks Foundation</h1>
                                                        <h2 class="mb30">SEP- Need Assesment Form 2</h2>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row"> 
                            ...
                            <div class="col-md-5">
                                <input type="text" class="form-control" name="SchoolID" placeholder="Enter School ID" required> <br>
                            </div>
                            </div>
                        </div>
                
<table style="width:20%" name="Sanitation">
  <tr>
...
<a href="volunteerpanel3.jsp">Next</a> 
</form>
